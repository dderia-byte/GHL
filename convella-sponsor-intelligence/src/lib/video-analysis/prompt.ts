...
- If nothing conclusive is found in this chunk, set "recognised": false and still return any partial evidence (e.g. a brand mention without commercial context) with an honest, lower "strength".
